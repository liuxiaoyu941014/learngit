...
RSpec.describe PostsController, type: :controller do
  ...
  describe 'Comments' do
    describe "GET #comment_index" do
      it "assigns all comments as @comments" do
        # binding.pry
        post_rec = create(:post)
        Comment::Entry.create(
          user_id: valid_session[:user_id],
          resource: post_rec,
          content: 'my content'
        )
        get :comments_index, params: {id: post_rec.id}, session: valid_session
    ...
    describe "POST #create_comment" do
      it "create" do
        ...
        expect {
          post :create_comment, params: { id: post_rec.id, comment: valid_attributes }, session: valid_session
        }.to change(Comment::Entry, :count).by(1)
      end
    end
  end
