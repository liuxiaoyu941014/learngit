...
RSpec.describe Cms::PagesController, type: :controller do
  ...
  # Cms::PagesController. Be sure to keep this updated too.
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "redirects to the created cms_page" do
        post :create, params: {cms_page: valid_attributes}
        expect(response).to redirect_to(cms_page_url(Cms::Page.last))
      end
    end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested cms_page" do
        page = create(:page)
        put :update, params: {id: page.to_param, cms_page: new_attributes}
        page.reload
        skip("Add assertions for updated state")
      end
      it "redirects to the cms_page" do
        page = create(:page)
        put :update, params: {id: page.to_param, cms_page: valid_attributes}
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'edit' template)" do
        page = create(:page)
        put :update, params: {id: page.to_param, cms_page: invalid_attributes}
        expect(response).to be_success
      end
    end
  end
