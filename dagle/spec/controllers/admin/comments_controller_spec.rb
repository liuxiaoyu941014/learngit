...
RSpec.describe Admin::CommentsController, type: :controller do
  ...
  describe "GET #index" do
    it "returns a success response" do
      admin_comment = create(:admin_comment)
      get :index
  ...
  describe "GET #show" do
    it "returns a success response" do
      admin_comment = create(:admin_comment)
      get :show, params: {id: admin_comment.to_param}
      expect(response).to be_success
    end
  end
  ...
  describe "GET #edit" do
    it "returns a success response" do
      admin_comment = create(:admin_comment)
      get :edit, params: {id: admin_comment.to_param}
      expect(response).to be_success
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Admin::Comment" do
        expect {
          post :create, params: {admin_comment: valid_attributes}
        }.to change(Admin::Comment, :count).by(1)
      end

      it "redirects to the created admin_comment" do
        post :create, params: {admin_comment: valid_attributes}
        expect(response).to redirect_to(admin_comment_url(Admin::Comment.last))
      end
    end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested admin_comment" do
        admin_comment = create(:admin_comment)
        put :update, params: {id: admin_comment.to_param, admin_comment: new_attributes}
        admin_comment.reload
        skip("Add assertions for updated state")
      end
      it "redirects to the admin_comment" do
        admin_comment = create(:admin_comment)
        put :update, params: {id: admin_comment.to_param, admin_comment: valid_attributes}
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'edit' template)" do
        admin_comment = create(:admin_comment)
        put :update, params: {id: admin_comment.to_param, admin_comment: invalid_attributes}
        expect(response).to be_success
      end
    end
  end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested admin_comment" do
      admin_comment = create(:admin_comment)
      expect {
        delete :destroy, params: {id: admin_comment.to_param}
      }.to change(Admin::Comment, :count).by(-1)
    end
