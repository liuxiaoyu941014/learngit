...
RSpec.describe Admin::MaterialsController, type: :controller do
  ...
  # Admin::MaterialsController. Be sure to keep this updated too.
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "redirects to the created admin_material" do
        post :create, params: {material: valid_attributes}
        expect(response).to redirect_to(admin_material_url(Material.last))
      end
    end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested admin_material" do
        material = create(:material)
        put :update, params: {id: material.to_param, material: new_attributes}
        material.reload
        skip("Add assertions for updated state")
      end
      it "redirects to the admin_material" do
        material = create(:material)
        put :update, params: {id: material.to_param, material: valid_attributes}
        expect(response).to redirect_to(admin_material_url(material))
      end
    end
    context "with invalid params" do
  ...
  describe "DELETE #destroy" do
    it "destroys the requested admin_material" do
      material = create(:material)
      expect {
        delete :destroy, params: {id: material.to_param}
      }.to change(Material, :count).by(-1)
    end
    it "redirects to the admin_materials list" do
      material = create(:material)
      delete :destroy, params: {id: material.to_param}
      expect(response).to redirect_to(admin_materials_url)
    end
  end
end
