...
RSpec.describe Admin::DeliveriesController, type: :controller do
  ...
  # Admin::DeliveriesController. Be sure to keep this updated too.
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "redirects to the created admin_delivery" do
        post :create, params: {delivery: valid_attributes}
        expect(response).to redirect_to(admin_delivery_url(Delivery.last))
      end
    end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested admin_delivery" do
        delivery = create(:delivery)
        put :update, params: {id: delivery.to_param, delivery: new_attributes}
        delivery.reload
        skip("Add assertions for updated state")
      end
      it "redirects to the admin_delivery" do
        delivery = create(:delivery)
        put :update, params: {id: delivery.to_param, delivery: valid_attributes}
        expect(response).to redirect_to(admin_delivery_url(delivery))
      end
    end
    context "with invalid params" do
  ...
  describe "DELETE #destroy" do
    it "destroys the requested admin_delivery" do
      delivery = create(:delivery)
      expect {
        delete :destroy, params: {id: delivery.to_param}
      }.to change(Delivery, :count).by(-1)
    end
    it "redirects to the admin_deliveries list" do
      delivery = create(:delivery)
      delete :destroy, params: {id: delivery.to_param}
      expect(response).to redirect_to(admin_deliveries_url)
    end
  end
end
